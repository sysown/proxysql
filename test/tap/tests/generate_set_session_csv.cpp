...
//	vars["session_track_gtids"]->add("ALL_GTID");
	...
	vars["wsrep_trx_fragment_size"] = std::make_unique<variable>("wsrep_trx_fragment_size", true, true, false);
	vars["wsrep_trx_fragment_size"]->add(int_values_small, 100);
	vars["wsrep_trx_fragment_unit"] = std::make_unique<variable>("wsrep_trx_fragment_unit", true, false, false);
