...
int main() {
...

	{
		...
		db3.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('rr3', '127.0.0.1:6606', 30, 'round_robin', 1)");

		MysqlxConfigStore s;
		s.load_from_runtime(db3, err);
...

	{
		...
		dbw.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('rr_wrap', '127.0.0.1:6607', 31, 'round_robin', 1)");

		MysqlxConfigStore s;
		s.load_from_runtime(dbw, err);
...

	{
		...
		dbphg.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('rr_hg10', '127.0.0.1:6610', 10, 'round_robin', 1)");
		dbphg.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('rr_hg20', '127.0.0.1:6620', 20, 'round_robin', 1)");

		MysqlxConfigStore s;
		s.load_from_runtime(dbphg, err);
...

	{
		...
		dbfa3.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('fa3', '127.0.0.1:6609', 33, 'first_available', 1)");

		MysqlxConfigStore s;
		s.load_from_runtime(dbfa3, err);
...

	{
		...
		dbmix.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('mix_rr', '127.0.0.1:6611', 34, 'round_robin', 1)");
		dbmix.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('mix_fa', '127.0.0.1:6612', 34, 'first_available', 1)");

		MysqlxConfigStore s;
		s.load_from_runtime(dbmix, err);
...

	{
		...
		dbfb.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, fallback_hostgroup, strategy, active) VALUES ('fb_primary', '127.0.0.1:6613', 40, 41, 'first_available', 1)");

		MysqlxConfigStore s;
		s.load_from_runtime(dbfb, err);
...

	{
		...
		dbrrfb.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, fallback_hostgroup, strategy, active) VALUES ('rrfb_pri', '127.0.0.1:6616', 45, 46, 'round_robin_with_fallback', 1)");

		MysqlxConfigStore s;
		s.load_from_runtime(dbrrfb, err);
...

	{
		...
		dbia2.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('active_route', '127.0.0.1:6618', 51, 'first_available', 1)");
		dbia2.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('inactive_route2', '127.0.0.1:6619', 52, 'first_available', 0)");

		MysqlxConfigStore s;
		s.load_from_runtime(dbia2, err);
...

	{
		...
		dbia3.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('all_off2', '127.0.0.1:6621', 53, 'round_robin', 0)");

		MysqlxConfigStore s;
		s.load_from_runtime(dbia3, err);
...

	{
		...
		dbeo.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('eo_port', '127.0.0.1:6622', 60, 'first_available', 1)");

		MysqlxConfigStore s;
		s.load_from_runtime(dbeo, err);
...

	{
		...
		dbss.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('eo_ssl', '127.0.0.1:6623', 61, 'first_available', 1)");

		MysqlxConfigStore s;
		s.load_from_runtime(dbss, err);
...

	{
		...
		dbmr.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('mr_r1', '127.0.0.1:6625', 70, 'first_available', 1)");
		dbmr.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('mr_r2', '127.0.0.1:6626', 71, 'first_available', 1)");

		MysqlxConfigStore s;
		s.load_from_runtime(dbmr, err);
...

	{
		...
		dbss2.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('ss_rr', '127.0.0.1:6627', 80, 'round_robin', 1)");
		dbss2.execute("INSERT INTO runtime_mysqlx_routes (name, bind, destination_hostgroup, strategy, active) VALUES ('ss_fa', '127.0.0.1:6628', 80, 'first_available', 1)");

		MysqlxConfigStore s;
		s.load_from_runtime(dbss2, err);
