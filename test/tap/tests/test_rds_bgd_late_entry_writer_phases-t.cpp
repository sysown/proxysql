 ...
 */
int test_first_initiated(MYSQL* admin, RDS_BGD_Simulator& sim, TestState& state) {
 ...
 */
int test_first_in_progress(MYSQL* admin, RDS_BGD_Simulator& sim, TestState& state) {
 ...
 */
int test_first_post_processing(CommandLine& cl, MYSQL* admin, RDS_BGD_Simulator& sim, TestState& state) {
