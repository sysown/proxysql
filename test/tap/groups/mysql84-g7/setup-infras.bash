...
if [ -d "${WORKSPACE}/test/tap/tests/reg_test_3223_scripts" ]; then
    echo ">>> [mysql84/setup-infras] Copying RESTAPI test scripts to ProxySQL data directory..."
    ...
    echo ">>> [mysql84/setup-infras] RESTAPI scripts copied successfully"
else
    echo ">>> [mysql84/setup-infras] WARNING: RESTAPI scripts not found at ${WORKSPACE}/test/tap/tests/reg_test_3223_scripts"
fi

echo ">>> [mysql84/setup-infras] Setup complete"
