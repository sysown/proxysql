...
if [ -d "${WORKSPACE}/test/tap/tests/reg_test_3223_scripts" ]; then
    echo ">>> [mysql95/setup-infras] Copying RESTAPI test scripts to ProxySQL data directory..."
    ...
    echo ">>> [mysql95/setup-infras] RESTAPI scripts copied successfully"
else
    echo ">>> [mysql95/setup-infras] WARNING: RESTAPI scripts not found at ${WORKSPACE}/test/tap/tests/reg_test_3223_scripts"
fi

echo ">>> [mysql95/setup-infras] Setup complete"
