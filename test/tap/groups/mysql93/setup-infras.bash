...
if [ -d "${WORKSPACE}/test/tap/tests/reg_test_3223_scripts" ]; then
    echo ">>> [mysql93/setup-infras] Copying RESTAPI test scripts to ProxySQL data directory..."
    ...
    echo ">>> [mysql93/setup-infras] RESTAPI scripts copied successfully"
else
    echo ">>> [mysql93/setup-infras] WARNING: RESTAPI scripts not found at ${WORKSPACE}/test/tap/tests/reg_test_3223_scripts"
fi

echo ">>> [mysql93/setup-infras] Setup complete"
