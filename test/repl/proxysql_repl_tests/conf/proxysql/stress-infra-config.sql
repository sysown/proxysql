...
INSERT INTO mysql_servers (hostgroup_id,hostname,port,use_ssl,max_replication_lag,max_connections,comment) VALUES (${RHG},'${MYSQL4_HOST}${INFRA}',${MYSQL4_PORT},${USE_SSL},180,500,'${MYSQL4_HOST}${INFRA}');
INSERT INTO mysql_servers (hostgroup_id,hostname,port,use_ssl,max_replication_lag,max_connections,comment) VALUES (${RHG},'${MYSQL5_HOST}${INFRA}',${MYSQL5_PORT},${USE_SSL},180,500,'${MYSQL5_HOST}${INFRA}');
