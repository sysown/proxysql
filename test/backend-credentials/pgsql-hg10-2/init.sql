-- Hostgroup 10 Server 2 - PostgreSQL Read server initialization
...
INSERT INTO test_reads (server_name, data) VALUES
    ('pgsql-hg10-2', 'PG Read server 2 - row 1'),
    ('pgsql-hg10-2', 'PG Read server 2 - row 2'),
    ('pgsql-hg10-2', 'PG Read server 2 - row 3');
