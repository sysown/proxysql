...
echo "========================================================================"
echo "dbdeployer entrypoint: deploying MySQL 5.7 replication + binlog readers..."
echo "========================================================================"
...
INFRA="${INFRA:-infra-dbdeployer-mysql57-binlog}"
...
# Set read_only=1 on replicas (ports 3307, 3308) to match infra-mysql57-binlog behavior
...
echo "========================================================================"
echo "dbdeployer MySQL 5.7 replication + binlog readers is ready."
