...
INSERT INTO mysql_servers (hostgroup_id,hostname,port,max_replication_lag,comment) VALUES (${WHG},'dbdeployer1.${INFRA}',3306,1,'dbdeployer1.${INFRA}');
INSERT INTO mysql_servers (hostgroup_id,hostname,port,max_replication_lag,comment) VALUES (${RHG},'dbdeployer1.${INFRA}',3306,1,'dbdeployer1.${INFRA}');
INSERT INTO mysql_servers (hostgroup_id,hostname,port,max_replication_lag,comment) VALUES (${RHG},'dbdeployer1.${INFRA}',3307,1,'dbdeployer1.${INFRA}');
INSERT INTO mysql_servers (hostgroup_id,hostname,port,max_replication_lag,comment) VALUES (${RHG},'dbdeployer1.${INFRA}',3308,1,'dbdeployer1.${INFRA}');
...
INSERT INTO mysql_group_replication_hostgroups (writer_hostgroup,backup_writer_hostgroup,reader_hostgroup,offline_hostgroup,active,max_writers,writer_is_also_reader,max_transactions_behind,comment) VALUES (${WHG},${BHG},${RHG},${OHG},1,1,1,0,'${INFRA}');
