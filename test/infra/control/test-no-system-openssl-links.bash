...
pattern="(^|[[:space:]\"'=])(-lssl|-lcrypto)([[:space:]\"'=]|$)|-Wl,[^[:space:]]*-l(ssl|crypto)(,|[[:space:]]|$)|-Wl,[^[:space:]]*-l,(ssl|crypto)(,|[[:space:]]|$)|-Xlinker([[:space:]]|=)+-l(ssl|crypto)([[:space:]\"'=]|$)|-l:(libssl|libcrypto)([.[:space:]\"'=]|$)|brew --prefix openssl|CUSTOM_OPENSSL_PATH|OPENSSL_ROOT_DIR[[:space:]]*[:?+]?=[[:space:]]*(/usr|/opt)|/usr/include/openssl|/(usr|lib|opt)/(local/)?lib[^[:space:]\"']*/lib(ssl|crypto)[.](a|so([.][0-9]+)*|dylib)|/(usr/local|opt/homebrew)/(opt|Cellar)/openssl[^[:space:]\"']*/lib/lib(ssl|crypto)[.](a|so([.][0-9]+)*|dylib)"
