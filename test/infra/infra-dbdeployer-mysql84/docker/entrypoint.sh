...
echo "========================================================================"
echo "dbdeployer entrypoint: deploying MySQL 8.4 replication (3 nodes)..."
echo "========================================================================"
...
INFRA="${INFRA:-infra-dbdeployer-mysql84}"
...
# Set read_only=1 on replicas (ports 3307, 3308) to match infra-mysql84 behavior
...
echo "========================================================================"
echo "dbdeployer MySQL 8.4 replication is ready."
