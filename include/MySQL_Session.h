...
private:
  ...
  void handler___status_CONNECTING_CLIENT___STATE_SERVER_HANDSHAKE(PtrSize_t *,
                                                                   bool *);

  void
  handler___status_CHANGING_USER_CLIENT___STATE_CLIENT_HANDSHAKE(PtrSize_t *,
                                                                 bool *);
...
public:
  ...
  bool started_sending_data_to_client; // this status variable tracks if some
                                       // result set was sent to the client, of
                                       // if proysql is still buffering
                                       // everything
