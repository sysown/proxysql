...
public:
	...
	virtual char * lookup(char *username, char *pass, 
			...
			char **backend_username) {return nullptr;};
	...
	virtual char **get_variables_list() {return nullptr;}
	virtual bool has_variable(const char *name) {return false;};
	virtual char * get_variable(char *name) {return nullptr;};
	virtual bool set_variable(char *name, char *value) {return false;};

	virtual void load_mysql_ldap_mapping(SQLite3_result *result) {};
	virtual SQLite3_result * dump_table_mysql_ldap_mapping() { return nullptr; };
	virtual SQLite3_result * dump_table_pgsql_ldap_mapping() { return nullptr; };
	virtual uint64_t get_ldap_mapping_runtime_checksum() { return 0; };
	virtual SQLite3_result * SQL3_getStats() { return nullptr; }
