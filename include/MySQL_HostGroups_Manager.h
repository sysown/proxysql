...
class AWS_Aurora_Info {
	...
	bool active;
	bool __active;
	AWS_Aurora_Info(int w, int r, int ml, int ci, int ct, bool _a, int wiar, int nrw, char *c);
	bool update(int r, int ml, int ci, int ct, bool _a, int wiar, int nrw, char *c);
	~AWS_Aurora_Info();
};
