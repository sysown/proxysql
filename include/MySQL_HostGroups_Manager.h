...
// Seconds to keep a blue reader SHUNNED after an AWS RDS blue/green switchover,
// giving AWS time to migrate it before it rejoins the reader hostgroup.
#define AWS_RDS_BGD_UNSHUN_DELAY_SEC 15
