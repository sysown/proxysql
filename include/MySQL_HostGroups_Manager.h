...
// NOTE: Table schemas are defined in Base_HostGroups_Manager.h with "IF NOT EXISTS" clauses
// to prevent SQLite errors during module restarts (issue #5221)
// See Base_HostGroups_Manager.h for detailed Doxygen documentation
