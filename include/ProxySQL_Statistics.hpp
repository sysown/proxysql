...
#define STATSDB_SQLITE_TABLE_HISTORY_MYSQL_STATUS_VARIABLES_V2_0_10 "CREATE TABLE history_mysql_status_variables (timestamp INT NOT NULL PRIMARY KEY , Access_Denied_Max_Connections VARCHAR NOT NULL DEFAULT '' , Access_Denied_Max_User_Connections VARCHAR NOT NULL DEFAULT '' , Access_Denied_Wrong_Password VARCHAR NOT NULL DEFAULT '' , Active_Transactions VARCHAR NOT NULL DEFAULT '' , Backend_query_time_nsec VARCHAR NOT NULL DEFAULT '' , Client_Connections_aborted VARCHAR NOT NULL DEFAULT '' , Client_Connections_connected VARCHAR NOT NULL DEFAULT '' , Client_Connections_created VARCHAR NOT NULL DEFAULT '' , Client_Connections_hostgroup_locked VARCHAR NOT NULL DEFAULT '' , Client_Connections_non_idle VARCHAR NOT NULL DEFAULT '' , Com_autocommit VARCHAR NOT NULL DEFAULT '' , Com_autocommit_filtered VARCHAR NOT NULL DEFAULT '' , Com_backend_change_user VARCHAR NOT NULL DEFAULT '' , Com_backend_init_db VARCHAR NOT NULL DEFAULT '' , Com_backend_set_names VARCHAR NOT NULL DEFAULT '' , Com_backend_stmt_close VARCHAR NOT NULL DEFAULT '' , Com_backend_stmt_execute VARCHAR NOT NULL DEFAULT '' , Com_backend_stmt_prepare VARCHAR NOT NULL DEFAULT '' , Com_commit VARCHAR NOT NULL DEFAULT '' , Com_commit_filtered VARCHAR NOT NULL DEFAULT '' , Com_frontend_init_db VARCHAR NOT NULL DEFAULT '' , Com_frontend_set_names VARCHAR NOT NULL DEFAULT '' , Com_frontend_stmt_close VARCHAR NOT NULL DEFAULT '' , Com_frontend_stmt_execute VARCHAR NOT NULL DEFAULT '' , Com_frontend_stmt_prepare VARCHAR NOT NULL DEFAULT '' , Com_frontend_use_db VARCHAR NOT NULL DEFAULT '' , Com_rollback VARCHAR NOT NULL DEFAULT '' , Com_rollback_filtered VARCHAR NOT NULL DEFAULT '' , ConnPool_get_conn_failure VARCHAR NOT NULL DEFAULT '' , ConnPool_get_conn_immediate VARCHAR NOT NULL DEFAULT '' , ConnPool_get_conn_latency_awareness VARCHAR NOT NULL DEFAULT '' , ConnPool_get_conn_success VARCHAR NOT NULL DEFAULT '' , GTID_consistent_queries VARCHAR NOT NULL DEFAULT '' , GTID_session_collected VARCHAR NOT NULL DEFAULT '' , Mirror_concurrency VARCHAR NOT NULL DEFAULT '' , Mirror_queue_length VARCHAR NOT NULL DEFAULT '' , MyHGM_myconnpoll_destroy VARCHAR NOT NULL DEFAULT '' , MyHGM_myconnpoll_get VARCHAR NOT NULL DEFAULT '' , MyHGM_myconnpoll_get_ok VARCHAR NOT NULL DEFAULT '' , MyHGM_myconnpoll_push VARCHAR NOT NULL DEFAULT '' , MyHGM_myconnpoll_reset VARCHAR NOT NULL DEFAULT '' , MySQL_Monitor_Workers VARCHAR NOT NULL DEFAULT '' , MySQL_Monitor_Workers_Aux VARCHAR NOT NULL DEFAULT '' , MySQL_Monitor_Workers_Started VARCHAR NOT NULL DEFAULT '' , MySQL_Monitor_connect_check_ERR VARCHAR NOT NULL DEFAULT '' , MySQL_Monitor_connect_check_OK VARCHAR NOT NULL DEFAULT '' , MySQL_Monitor_ping_check_ERR VARCHAR NOT NULL DEFAULT '' , MySQL_Monitor_ping_check_OK VARCHAR NOT NULL DEFAULT '' , MySQL_Monitor_read_only_check_ERR VARCHAR NOT NULL DEFAULT '' , MySQL_Monitor_read_only_check_OK VARCHAR NOT NULL DEFAULT '' , MySQL_Monitor_replication_lag_check_ERR VARCHAR NOT NULL DEFAULT '' , MySQL_Monitor_replication_lag_check_OK VARCHAR NOT NULL DEFAULT '' , MySQL_Thread_Workers VARCHAR NOT NULL DEFAULT '' , ProxySQL_Uptime VARCHAR NOT NULL DEFAULT '' , Queries_backends_bytes_recv VARCHAR NOT NULL DEFAULT '' , Queries_backends_bytes_sent VARCHAR NOT NULL DEFAULT '' , Queries_frontends_bytes_recv VARCHAR NOT NULL DEFAULT '' , Queries_frontends_bytes_sent VARCHAR NOT NULL DEFAULT '' , Query_Processor_time_nsec VARCHAR NOT NULL DEFAULT '' , Questions VARCHAR NOT NULL DEFAULT '' , Selects_for_update__autocommit0 VARCHAR NOT NULL DEFAULT '' , Server_Connections_aborted VARCHAR NOT NULL DEFAULT '' , Server_Connections_connected VARCHAR NOT NULL DEFAULT '' , Server_Connections_created VARCHAR NOT NULL DEFAULT '' , Server_Connections_delayed VARCHAR NOT NULL DEFAULT '' , Servers_table_version VARCHAR NOT NULL DEFAULT '' , Slow_queries VARCHAR NOT NULL DEFAULT '' , automatic_detected_sql_injection VARCHAR NOT NULL DEFAULT '' , aws_aurora_replicas_skipped_during_query VARCHAR NOT NULL DEFAULT '' , backend_lagging_during_query VARCHAR NOT NULL DEFAULT '' , backend_offline_during_query VARCHAR NOT NULL DEFAULT '' , generated_error_packets VARCHAR NOT NULL DEFAULT '' , hostgroup_locked_queries VARCHAR NOT NULL DEFAULT '' , hostgroup_locked_set_cmds VARCHAR NOT NULL DEFAULT '' , max_connect_timeouts VARCHAR NOT NULL DEFAULT '' , mysql_backend_buffers_bytes VARCHAR NOT NULL DEFAULT '' , mysql_frontend_buffers_bytes VARCHAR NOT NULL DEFAULT '' , mysql_killed_backend_connections VARCHAR NOT NULL DEFAULT '' , mysql_killed_backend_queries VARCHAR NOT NULL DEFAULT '' , mysql_session_internal_bytes VARCHAR NOT NULL DEFAULT '' , mysql_unexpected_frontend_com_quit VARCHAR NOT NULL DEFAULT '' , mysql_unexpected_frontend_packets VARCHAR NOT NULL DEFAULT '' , queries_with_max_lag_ms VARCHAR NOT NULL DEFAULT '' , queries_with_max_lag_ms__delayed VARCHAR NOT NULL DEFAULT '' , queries_with_max_lag_ms__total_wait_time_us VARCHAR NOT NULL DEFAULT '' , whitelisted_sqli_fingerprint VARCHAR NOT NULL DEFAULT '' )"
