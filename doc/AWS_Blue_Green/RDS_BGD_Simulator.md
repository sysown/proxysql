...
| Direct-probe policy | Vary blue/green IP, supported port, and blue versus explicit-green `use_ssl`. | Probe-log rows identify the green IP, matched writer port, and correct automatic or explicit TLS source. |
