...
void ProxySQL_Admin::disk_upgrade_mysql_query_rules() {
	...
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V1_1_0);
	if (rci) {
		// upgrade is required
		...
		// create new table
		configdb->build_table("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES,false);
	...
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V1_2_0a);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V1_2_0g);
	if (rci) {
		// upgrade is required
	...
	// upgrade related to issue #643 , adding comment in mysql_query_rules table
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V1_2_2);
	if (rci) {
		// upgrade is required
	...
	// upgrade related to issue #643 , adding comment in mysql_query_rules table
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V1_3_1);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V1_4_0a);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V1_4_0b);
	...
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V1_4_1);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V2_0_0a);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V2_0_0b);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V2_0_0c);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V2_0_0d);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_query_rules",ADMIN_SQLITE_TABLE_MYSQL_QUERY_RULES_V2_0_0e);
	if (rci) {
		// upgrade is required
...
void ProxySQL_Admin::disk_upgrade_scheduler() {
	...
	int rci;
	configdb->execute("PRAGMA foreign_keys = OFF");
	rci=configdb->check_table_structure("scheduler",ADMIN_SQLITE_TABLE_SCHEDULER_V1_2_0);
	if (rci) {
		// upgrade is required
		...
		// create new table
		configdb->build_table("scheduler",ADMIN_SQLITE_TABLE_SCHEDULER,false);
		// copy fields from old table
	...
	rci=configdb->check_table_structure("scheduler",ADMIN_SQLITE_TABLE_SCHEDULER_V1_2_2a);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("scheduler",ADMIN_SQLITE_TABLE_SCHEDULER_V1_2_2b);
	if (rci) {
		// upgrade is required
...
void ProxySQL_Admin::disk_upgrade_mysql_servers() {
	...
	int rci;
	configdb->execute("PRAGMA foreign_keys = OFF");
	rci=configdb->check_table_structure("mysql_servers",ADMIN_SQLITE_TABLE_MYSQL_SERVERS_V1_1_0);
	if (rci) {
		// upgrade is required
		...
		// create new table
		configdb->build_table("mysql_servers",ADMIN_SQLITE_TABLE_MYSQL_SERVERS,false);
		// fix bug #1224
	...
	rci=configdb->check_table_structure("mysql_servers",ADMIN_SQLITE_TABLE_MYSQL_SERVERS_V1_2_0e);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_servers",ADMIN_SQLITE_TABLE_MYSQL_SERVERS_V1_2_2);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_servers",ADMIN_SQLITE_TABLE_MYSQL_SERVERS_V1_4_4); // 1.4.4 has the same column of 1.2.2
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_servers",ADMIN_SQLITE_TABLE_MYSQL_SERVERS_V2_0_0a);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_servers",ADMIN_SQLITE_TABLE_MYSQL_SERVERS_V2_0_0b);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_servers",ADMIN_SQLITE_TABLE_MYSQL_SERVERS_V2_0_0c);
	if (rci) {
	...
	rci=configdb->check_table_structure("mysql_replication_hostgroups",ADMIN_SQLITE_TABLE_MYSQL_REPLICATION_HOSTGROUPS_V1_0); // issue #643
	if (rci) {
		// upgrade is required
		...
		// create new table
		configdb->build_table("mysql_replication_hostgroups",ADMIN_SQLITE_TABLE_MYSQL_REPLICATION_HOSTGROUPS,false);
		// copy fields from old table
	...
	rci=configdb->check_table_structure("mysql_replication_hostgroups",ADMIN_SQLITE_TABLE_MYSQL_REPLICATION_HOSTGROUPS_V1_2_2); // issue #1304
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_replication_hostgroups",ADMIN_SQLITE_TABLE_MYSQL_REPLICATION_HOSTGROUPS_V1_4_5); // issue #1304
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_replication_hostgroups",ADMIN_SQLITE_TABLE_MYSQL_REPLICATION_HOSTGROUPS_V2_0_0); // issue #2186
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_group_replication_hostgroups",ADMIN_SQLITE_TABLE_MYSQL_GROUP_REPLICATION_HOSTGROUPS_V1_4);
	if (rci) {
		// upgrade is required
		...
		// create new table
		configdb->build_table("mysql_group_replication_hostgroups",ADMIN_SQLITE_TABLE_MYSQL_GROUP_REPLICATION_HOSTGROUPS,false);
		// copy fields from old table
	...
	rci=configdb->check_table_structure("mysql_galera_hostgroups",ADMIN_SQLITE_TABLE_MYSQL_GALERA_HOSTGROUPS_V2_0_0a);
	if (rci) {
		// upgrade is required
		...
		// create new table
		configdb->build_table("mysql_galera_hostgroups",ADMIN_SQLITE_TABLE_MYSQL_GALERA_HOSTGROUPS,false);
		// copy fields from old table
	...
	rci=configdb->check_table_structure("mysql_aws_aurora_hostgroups",ADMIN_SQLITE_TABLE_MYSQL_AWS_AURORA_HOSTGROUPS_V2_0_8);
	if (rci) {
		// upgrade is required
		...
		// create new table
		configdb->build_table("mysql_aws_aurora_hostgroups",ADMIN_SQLITE_TABLE_MYSQL_AWS_AURORA_HOSTGROUPS,false);
		// copy fields from old table
	...
	rci=configdb->check_table_structure("mysql_aws_aurora_hostgroups", ADMIN_SQLITE_TABLE_MYSQL_AWS_AURORA_HOSTGROUPS_V2_0_9);
	if (rci) {
		// upgrade is required
	...
	// Upgrade mysql_aws_aurora_hostgroups from V2_0_10 to V3_0_12
	// (adds nullable green_writer_hostgroup and green_reader_hostgroup columns).
	rci=configdb->check_table_structure("mysql_aws_aurora_hostgroups", ADMIN_SQLITE_TABLE_MYSQL_AWS_AURORA_HOSTGROUPS_V2_0_10);
	if (rci) {
		proxy_warning("Detected version pre-v3.0.12 of mysql_aws_aurora_hostgroups\n");
		proxy_warning("ONLINE UPGRADE of table mysql_aws_aurora_hostgroups in progress\n");
		configdb->execute("DROP TABLE IF EXISTS mysql_aws_aurora_hostgroups_v2010");
		configdb->execute("ALTER TABLE mysql_aws_aurora_hostgroups RENAME TO mysql_aws_aurora_hostgroups_v2010");
		configdb->build_table("mysql_aws_aurora_hostgroups",ADMIN_SQLITE_TABLE_MYSQL_AWS_AURORA_HOSTGROUPS,false);
		configdb->execute(
			...
			") SELECT "
				...
				"check_interval_ms, check_timeout_ms, writer_is_also_reader, new_reader_weight, "
				"add_lag_ms, min_lag_ms, lag_num_checks, autopurge_missing_checks, comment "
			"FROM mysql_aws_aurora_hostgroups_v2010"
		);
	}

	// upgrade mysql_hostgroup_attributes
	rci=configdb->check_table_structure("mysql_hostgroup_attributes",ADMIN_SQLITE_TABLE_MYSQL_HOSTGROUP_ATTRIBUTES_V2_5_0);
	if (rci) {
		// upgrade is required
		...
		// create new table
		configdb->build_table("mysql_hostgroup_attributes",ADMIN_SQLITE_TABLE_MYSQL_HOSTGROUP_ATTRIBUTES,false);
		// copy fields from old table
		configdb->execute(
	...
	rci = configdb->check_table_structure("mysql_hostgroup_attributes", ADMIN_SQLITE_TABLE_MYSQL_HOSTGROUP_ATTRIBUTES_V2_5_2);
	if (rci) {
		// upgrade is required
...
void ProxySQL_Admin::disk_upgrade_mysql_users() {
	...
	rci=configdb->check_table_structure("mysql_users",ADMIN_SQLITE_TABLE_MYSQL_USERS_V1_3_0);
	if (rci) {
		// upgrade is required
		...
		// create new table
		configdb->build_table("mysql_users",ADMIN_SQLITE_TABLE_MYSQL_USERS,false);
		// copy fields from old table
	...
	rci=configdb->check_table_structure("mysql_users",ADMIN_SQLITE_TABLE_MYSQL_USERS_V1_4_0);
	if (rci) {
		// upgrade is required
	...
	rci=configdb->check_table_structure("mysql_users",ADMIN_SQLITE_TABLE_MYSQL_USERS_V2_0_0);
	if (rci) {
		// upgrade is required
...
void ProxySQL_Admin::disk_upgrade_rest_api_routes() {
	...
	rci=configdb->check_table_structure("restapi_routes",ADMIN_SQLITE_TABLE_RESTAPI_ROUTES_V2_0_15);
	if (rci) {
		// upgrade is required
		...
		// create new table
		configdb->build_table("restapi_routes",ADMIN_SQLITE_TABLE_RESTAPI_ROUTES,false);
		// copy fields from old table
